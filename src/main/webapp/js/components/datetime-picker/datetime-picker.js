...
function ($compile, $parse, $document, $position, dateFilter, dateParser, datepickerPopupConfig) {
    return {
        ...
        link: function (scope, element, attrs, ngModel) {
            ...
            // default text
            scope.todayText = scope.todayText || 'היום';
            scope.nowText = scope.nowText || 'עכשיו';
            scope.clearText = scope.clearText || 'נקה';
            scope.closeText = scope.closeText || 'סגור';
            scope.dateText = scope.dateText || 'בחר תאריך';
            scope.timeText = scope.timeText || 'בחר שעה';
            ...
            var popupEl = angular.element('' +
                '<div datetime-picker-popup>' +
                    '<div collapse="showPicker == \'time\'">' +
                        '<div datepicker></div>' +
                    '</div>' +
                    '<div collapse="showPicker == \'date\'" ng-style="timeStyle" style="direction:ltr;">' +
